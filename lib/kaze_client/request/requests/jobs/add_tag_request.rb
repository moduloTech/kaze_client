...
# @note    This request is for the moment in re-development. It's not working well
...
#          (Jonathan and Florian know the subject)
# @example
...
# @see https://github.com/moduloTech/kaze_client
module KazeClient
